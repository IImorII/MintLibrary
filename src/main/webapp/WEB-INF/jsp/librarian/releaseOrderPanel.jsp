...
<html>
<head>
    <title><lc:lc_tag key="release_orders"/></title>
</head>
<body>
<jsp:include page="../header.jsp"/>
<div class="row tm-row">
    <div class="col-12">
        <form action="?command=release_order_panel" method="POST" class="tm-mb-40 tm-add-form form-inline">
                ...
                <c:forEach var="book" items="${requestScope.booksList}">
                    <tr class="odd gradeX">
                        ...
                        <td><a href="?command=release_order&accountId=${requestScope.account.id}&bookId=${book.id}"
                               class="mb-2 tm-btn tm-btn-primary tm-prev-next"><lc:lc_tag key="release"/></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
